...
class ComposerStaticInitc52ebfbf30fadb1cecddae09d70e0ca9
{
    ...
    public static $classMap = array (
        ...
        'UserFrosting\\UpdateTableController' => __DIR__ . '/../..' . '/controllers/UpdateTableController.php',
        'UserFrosting\\NextAssignTestController' => __DIR__ . '/../..' . '/controllers/NextAssignTestController.php',
        ...
        'UserFrosting\\StudentPerformance' => __DIR__ . '/../..' . '/models/database/StudentPerformance.php',
        'UserFrosting\\StudentsBio' => __DIR__ . '/../..' . '/models/database/StudentsBio.php',
        'UserFrosting\\TestResults' => __DIR__ . '/../..' . '/models/database/TestResults.php',
        'UserFrosting\\PostTestForm' => __DIR__ . '/../..' . '/models/database/PostTestForm.php',
        'UserFrosting\\ClassReference' => __DIR__ . '/../..' . '/models/database/ClassReference.php',
        'UserFrosting\\ExcessiveAbsences' => __DIR__ . '/../..' . '/models/database/ExcessiveAbsences.php',
        'UserFrosting\\StudentsTracking' => __DIR__ . '/../..' . '/models/database/StudentsTracking.php',
        'UserFrosting\\NextAssignTest' => __DIR__ . '/../..' . '/models/database/NextAssignTest.php',
