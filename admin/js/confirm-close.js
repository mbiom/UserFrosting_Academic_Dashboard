...
return new Array();},getFormElementValue:function(e){if(e.type!=undefined&&e.type=='radio'){return this.getFormRadioValue(e);}else if(e.type!=undefined&&e.type=='checkbox'){return this.getFormCheckValue(e);}else if(e.type=='password'){return null;}else if(e.value!=undefined){return e.value;}else{return null;}},getFormCheckValue:function(e){if(e.checked){return e.value;}
